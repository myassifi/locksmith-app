                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:flex-nowrap sm:justify-end">
                    ...
                    <Button
                      ...
                      aria-label={`Edit ${formatJobType(job.job_type)} job for ${job.customers?.name ?? 'customer'}`}
                      title="Edit job"
                    >
                    ...
                    <Button
                      ...
                      aria-label={`Delete ${formatJobType(job.job_type)} job for ${job.customers?.name ?? 'customer'}`}
                      title="Delete job"
                    >
