...
((SELECT id FROM customers WHERE name = 'Robert Taylor'), 'all_keys_lost', '2023-08-15', 'paid', 320.00, 'Complete vehicle key replacement', 'Ford F-150 2017 - all keys lost'),
((SELECT id FROM customers WHERE name = 'Jennifer Brown'), 'house_rekey', '2023-07-20', 'paid', 180.00, 'Security upgrade after break-in', 'All exterior doors'),
((SELECT id FROM customers WHERE name = 'David Wilson'), 'lock_repair', '2023-06-10', 'paid', 45.00, 'Garage door lock maintenance', NULL);
